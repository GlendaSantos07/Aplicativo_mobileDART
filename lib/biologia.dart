...
void main() {
  ...
  runApp(
    MaterialApp(
      home: Biologia(), // é a rota de entrada da aplicação (Start here)
      debugShowCheckedModeBanner: false, // remove o banner de debug do App
    ),
  );
}

class Biologia extends StatefulWidget {
  @override
  State<Biologia> createState() => _Biologia();
}


class _Biologia extends State<Biologia> {
  @override
